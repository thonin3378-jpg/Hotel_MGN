                  ...
                  <div class="card-body">
                    <form action="#" method="get">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ $myHotel->name }}" readonly="readonly">
                      </div>
                      <div class="form-group">
                        <label for="name" class="form-label text-primary">Address</label>
                        <input type="text" name="name" id="name" class="form-control" value="{{ $myHotel->address }}" readonly="readonly">
                      </div>
                      <div class="form-group">
                        <label for="email" class="form-label text-primary">Email to Contact Hotel</label>
                        <input type="text" name="email" id="email" class="form-control" placeholder="Your Email" value="{{ $myHotel->email }}">
                      </div>
                      <div class="form-group">
                        <label for="phone" class="form-label text-primary">Status</label>
                          @php
                            $myValue = ($myHotel->status == 0) ? "Booking" : "Free";
                          @endphp
                        <input type="text" name="phone" id="phone" class="form-control" placeholder="Your Phone" value=" {{ $myValue }} " readonly="readonly">
                      </div>
                      <div class="form-group">
                        <a href="{{ route('hotelImages.index') }}" type="submit" class="btn btn-primary">
                          Go Back
                        </a>
                      </div>
                    </form>
