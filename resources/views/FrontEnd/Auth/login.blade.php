...
<div id="auth">
    <div class="auth-card">
        ...
        <h1 class="auth-title">Welcome Back Front</h1>
        <p class="auth-subtitle">Enter your credentials to access your Front End.</p>

        <form method="POST" action="{{ route('FrontendLoginAction.action') }}">
            @csrf
        ...
        <div class="auth-footer">
            <p>Don't have an account? <a href="{{ route('Frontendregister') }}">Register</a></p>
